...
const viviendas = [
  {
    ...
    dormitorios: 3,
    superficie: "175,65 m²",
    precio: "Desde 590.000 €",
    plano: planoBajoA,
    text: "Vivienda amplia de tres dormitorios y dos baños, con jardín privado y una distribución pensada para disfrutar de una relación directa entre interior y exterior. Incorpora aerotermia con suelo radiante, trastero y la posibilidad de adquirir un espacio polivalente complementario en semisótano.",
  },
  {
    nombre: "Bajo B",
    planta: "Bajo",
    dormitorios: 3,
    superficie: "243,57 m²",
    precio: "Desde 725.000 €",
    plano: planoBajoB,
    text: "Vivienda amplia de tres dormitorios y dos baños, con jardín privado y espacio polivalente reformado en semisótano. Una propuesta especialmente versátil, con aerotermia mediante suelo radiante, trastero incluido y una distribución pensada para combinar comodidad interior, amplitud y vida al aire libre.",
  },
  {
    nombre: "1º A",
    ...
    dormitorios: 3,
    superficie: "131,32 m²",
    precio: "Desde 525.000 €",
    plano: planoPrimeroA,
    text: "Vivienda amplia de tres dormitorios y dos baños, situada en primera planta y con vistas hacia Plaza Santa Liberata. Una propuesta luminosa y equilibrada, con aerotermia mediante suelo radiante, trastero incluido y posibilidad de adquirir un espacio polivalente complementario en bajocubierta.",
  },
  {
    nombre: "1º B",
    planta: "Primera planta",
    dormitorios: 3,
    superficie: "133,91 m²",
    precio: "Desde 535.000 €",
    plano: planoPrimeroB,
    text: "Vivienda amplia de tres dormitorios y dos baños, situada en primera planta, con vistas hacia Plaza Santa Liberata y una distribución cómoda y funcional. Cuenta con aerotermia mediante suelo radiante, trastero incluido y posibilidad de adquirir un espacio polivalente complementario en bajocubierta.",
  },
];
