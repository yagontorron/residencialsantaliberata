    ...
    <footer style={{ backgroundColor: "var(--noir)", color: "var(--ivory)" }}>
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 py-20">
        <div className="grid md:grid-cols-3 gap-12 mb-16">
          <div>
            <div className="font-serif text-2xl tracking-[0.15em] uppercase mb-3">Casa Liberata</div>
        ...
        <p className="text-xs opacity-40 mt-6">© {new Date().getFullYear()} Casa Liberata</p>
      </div>
    </footer>
  );
}
